###########################################################################
## Makefile generated for component 'TriggerLineFollow'. 
## 
## Makefile     : TriggerLineFollow.mk
## Generated on : Fri Oct 13 15:08:58 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/TriggerLineFollow.elf
...
PRODUCT_NAME              = TriggerLineFollow
MAKEFILE                  = TriggerLineFollow.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2023a
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2023a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/siyan/DOCUME~1/Life/UCT/2023/S_SEM2/EEE3099S/EEE3099S/MILEST~2/MILEST~1
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/TriggerLineFollow.elf
...
DEFINES_STANDARD = -DMODEL=TriggerLineFollow -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_AnalogInput.o ArduinoPinHandleMap.o MW_arduino_digitalio.o MW_PWM.o MW_PWMDriver.o TriggerLineFollow.o TriggerLineFollow_data.o MW_ArduinoHWInit.o io_wrappers.o arduinoARM_M0plusScheduler.o m0m1m0plus_multitasking.o
...
%.o : $(START_DIR)/TriggerLineFollow_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/TriggerLineFollow_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/TriggerLineFollow_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/TriggerLineFollow_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/TriggerLineFollow_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
TriggerLineFollow.o : $(START_DIR)/TriggerLineFollow_ert_rtw/TriggerLineFollow.c
	$(CC) $(CFLAGS) -o "$@" "$<"


TriggerLineFollow_data.o : $(START_DIR)/TriggerLineFollow_ert_rtw/TriggerLineFollow_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/TriggerLineFollow_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
